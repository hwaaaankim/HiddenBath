	...
	public void sendMessage(
		...
		try {
			...
			String postParams = 
					...
					+"&sphone1=" + new String(Base64.encodeBase64("031".getBytes()))
					+"&sphone2=" + new String(Base64.encodeBase64("8011".getBytes()))
					+"&sphone3=" + new String(Base64.encodeBase64("3660".getBytes()))
